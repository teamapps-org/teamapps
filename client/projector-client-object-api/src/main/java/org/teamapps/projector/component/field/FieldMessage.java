...
public class FieldMessage {
	...
	public DtoFieldMessage createDtoFieldMessage(FieldMessagePosition defaultPosition, FieldMessageVisibility defaultVisibility) {
		DtoFieldMessage dtoFieldMessage = new DtoFieldMessage();
		dtoFieldMessage.setSeverity(severity);
		dtoFieldMessage.setMessage(message);
		dtoFieldMessage.setPosition(position != null ? position : defaultPosition);
		dtoFieldMessage.setVisibilityMode(visibility != null ? visibility : defaultVisibility);
		return dtoFieldMessage;
	}
