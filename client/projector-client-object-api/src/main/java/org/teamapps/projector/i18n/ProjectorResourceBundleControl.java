 ...
 */
public class ProjectorResourceBundleControl extends ResourceBundle.Control {

	private final String resourceFileSuffix;
	private final Locale fallbackLocale;

	public ProjectorResourceBundleControl(String resourceFileSuffix, Locale fallbackLocale) {
