 ...
 */
export class ProjectorEvent<EO> {

	private listeners: ProjectorEventListener<EO>[] = [];
	...
	public static createThrottled<EO>(delayMillis: number) {
		return new ProjectorEvent<EO>(fire => throttle(fire, delayMillis));
	}
	...
	public removeListener(fn: ProjectorEventListener<EO>) {
...
export function isProjectorEvent(e: any): e is ProjectorEvent<any> {
