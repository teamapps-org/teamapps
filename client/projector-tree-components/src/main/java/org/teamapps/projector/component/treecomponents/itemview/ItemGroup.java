...
public class ItemGroup<HEADERRECORD, RECORD> {
	...
	private FloatStyle floatStyle = FloatStyle.HORIZONTAL_FLOAT;
	private RowJustification itemJustification = RowJustification.LEFT;
	...
	public ItemGroup setFloatStyle(FloatStyle floatStyle) {
	...
	public RowJustification getItemJustification() {
		return itemJustification;
	}

	public ItemGroup setItemJustification(RowJustification itemJustification) {
