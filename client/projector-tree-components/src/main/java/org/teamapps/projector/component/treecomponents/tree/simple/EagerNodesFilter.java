...
public class EagerNodesFilter implements Predicate<SimpleTreeNode<?>> {

	private final SimpleTreeNode<?> evaluationRootNode;
	private final Map<SimpleTreeNode<?>, Boolean> includedInResultByNode = new HashMap<>();

	public EagerNodesFilter() {
		evaluationRootNode = null;
	}

	public EagerNodesFilter(SimpleTreeNode<?> evaluationRootNode) {
		this.evaluationRootNode = evaluationRootNode;
	}

	@Override
	public boolean test(SimpleTreeNode node) {
