...
export class LocalDateTimeField extends AbstractDateTimeField<DtoLocalDateTimeField, LocalDateTimeArray> implements DtoLocalDateTimeFieldEventSource, DtoLocalDateTimeFieldCommandHandler {
