...
public class LinkStyleSheet implements ClientObject, DtoLinkStyleSheetEventHandler {

	private final DtoLinkStyleSheetClientObjectChannel clientObjectChannel;

	private String url;

	public LinkStyleSheet(String url) {
		this.url = url;
		...
		this.clientObjectChannel = new DtoLinkStyleSheetClientObjectChannel(coc);
	}
	...
	@Override
	public DtoLinkStyleSheet createDto() {
		return new DtoLinkStyleSheet(url);
	}
	...
	public void setUrl(String url) {
		this.url = url;
		clientObjectChannel.setHref(url);
	}
}
