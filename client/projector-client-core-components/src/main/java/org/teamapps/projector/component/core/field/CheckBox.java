...
import org.teamapps.projector.component.core.DtoCheckBox;
import org.teamapps.projector.component.core.DtoCheckBoxClientObjectChannel;
import org.teamapps.projector.component.core.DtoCheckBoxEventHandler;
...
public class CheckBox extends AbstractField<Boolean> implements DtoCheckBoxEventHandler {
	...
	public DtoAbstractField createDto() {
		...
		mapAbstractFieldAttributes(uiCheckBox);
