...
export class IntervalManager {
	...
	public addInterval(newInterval: Interval) {
		console.trace("Adding interval: " + newInterval);
		let {
		...
		if (firstOverlappingExistingIntervalIndex === null && lastOverlappingExistingIntervalIndex == null) {
			...
			console.trace("NO OVERLAP. New intervals: " + this._intervals.map(interval => interval.toString()).join("; "));
		} else {
			...
			console.trace("Overlap detected, first: " + firstOverlappingInterval + ", last: " + lastOverlappingInterval + ". New intervals: " + this._intervals.map(interval => interval.toString()).join("; "));
		}
	}
