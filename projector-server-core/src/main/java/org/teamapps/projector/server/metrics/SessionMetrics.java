 ...
 * =========================LICENSE_END==================================
 */
package org.teamapps.projector.server.metrics;
...
public class SessionMetrics implements MeterBinder {
	...
	public SessionMetrics(SessionManager sessionManager) {
	...
	public void bindTo(MeterRegistry registry) {
		...
		Gauge.builder("teamapps.uisession.commandbuffers.size", sessionManager, SessionManager::getBufferedCommandsCount)
				.description("Current number of all commands in all command buffers.")
				.register(registry);

		Gauge.builder("teamapps.uisession.commandbuffers.unconsumed", sessionManager, SessionManager::getUnconsumedCommandsCount)
