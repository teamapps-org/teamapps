...
public class ProjectorServletContextListener implements ServletContextListener {

	private static final Logger LOGGER = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

	private final ProjectorServerCore projectorServerCore;

	public ProjectorServletContextListener(ProjectorServerCore projectorServerCore) {
	...
	public void contextInitialized(ServletContextEvent servletContextEvent) {
		...
		context.addListener(projectorServerCore.getSessionManager());
		...
		try {
			...
			ServerEndpointConfig communicationEndpointConfig = ServerEndpointConfig.Builder.create(WebSocketCommunicationEndpoint.class, "/communication")
					.configurator(new WebSocketServerEndpointConfigurator(projectorServerCore.getWebSocketCommunicationEndpoint()))
	...
	public void contextDestroyed(ServletContextEvent sce) {
		projectorServerCore.getSessionManager().destroy();
	}
