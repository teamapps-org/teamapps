...
public class ImageUploadStartedEventData {
	...
	public ImageUploadStartedEventData(String fileName, String mimeType, long sizeInBytes, int incompleteUploadsCount) {
