...
public class CurrencyField extends AbstractField<CurrencyValue> implements TextInputHandlingField {
	...
	public enum Currency {
		...
		KZT("KZT", "????", "Tenege", "Kazhakstan Tenege"),
		...
		SVC("SVC", null, "Salvadoran Col??n", "Salvadoran Col??n"),
		...
		UZS("UZS", "????", "Sums", "Uzbekistan Sums"),
		VEF("VEF", "Bs", "Bolivares Fuertes", "Venezuela Bolivares Fuertes"),
		VND("VND", "???", "Dong", "Viet Nam Dong"),
		XAF("XAF", null, "Communaut?? Financi??re Africaine Francs", "Communaut?? Financi??re Africaine Francs"),
		XCD("XCD", "$", "East Caribbean Dollars", "East Caribbean Dollars"),
		XOF("XOF", null, "Communaut?? Financi??re Africaine Francs", "Communaut?? Financi??re Africaine Francs"),
		XPF("XPF", null, "Comptoirs Fran??ais du Pacifique Francs", "Comptoirs Fran??ais du Pacifique Francs"),
