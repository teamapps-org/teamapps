...
public class InMemoryChatDisplayModel extends AbstractChatDisplayModel {
	...
	public void addMessage(Resolvable userImage, String userNickname, String text) {
		addMessage(userImage, userNickname, text, null, null, false);
	}

	public void addMessage(Resolvable userImage, String userNickname, String text, List<ChatPhoto> photos, List<ChatFile> files, boolean deleted) {
