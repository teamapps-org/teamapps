...
public class TeamAppsJettyEmbeddedServer {
	...
	public TeamAppsJettyEmbeddedServer(WebController webController, int port, TeamAppsConfiguration config) throws ServletException, IOException {
		this(webController, null, port, new TeamAppsConfiguration());
	}

	public TeamAppsJettyEmbeddedServer(WebController webController, File webAppDirectory) throws ServletException, IOException {
		this(webController, webAppDirectory, new TeamAppsConfiguration());
	}

	public TeamAppsJettyEmbeddedServer(WebController webController, File webAppDirectory, TeamAppsConfiguration config) throws ServletException, IOException {
		this(webController, webAppDirectory, 8080, config);
	}

	public TeamAppsJettyEmbeddedServer(WebController webController, File webAppDirectory, int port) throws ServletException, IOException {
		this(webController, webAppDirectory, port, new TeamAppsConfiguration());
	}

	public TeamAppsJettyEmbeddedServer(WebController webController, File webAppDirectory, int port, TeamAppsConfiguration config) throws ServletException, IOException {
