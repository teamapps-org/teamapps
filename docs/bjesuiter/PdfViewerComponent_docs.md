...
**Start (background):**
```bash
bgproc start -n teamapps-frontend -- /bin/zsh -lc "cd /Users/bjesuiter/Develop/teamapps-org/teamapps/teamapps-client && ./start-dev-server.sh 8082"
```
