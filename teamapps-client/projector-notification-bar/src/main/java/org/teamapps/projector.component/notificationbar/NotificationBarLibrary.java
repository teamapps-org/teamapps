...
public class NotificationBarLibrary implements ClientObjectLibrary {
	...
	public NotificationBarLibrary() {
		this.resourceProvider = new ClassPathResourceProvider("org/teamapps/projector/components/notificationbar/resources/js");
	}

	@Override
	public Resource getMainJsResource() {
		return new ClassPathResource("org/teamapps/projector/components/notificationbar/resources/js/index.js", "text/javascript");
	}

	@Override
	public Resource getMainCssResource() {
		return new ClassPathResource("org/teamapps/projector/components/notificationbar/resources/js/index.css", "text/css");
	}
