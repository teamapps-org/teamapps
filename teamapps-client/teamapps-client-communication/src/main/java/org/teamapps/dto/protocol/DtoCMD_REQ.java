...
public class DtoCMD_REQ extends DtoAbstractClientMessage {
	...
	@JsonCreator
	public DtoCMD_REQ(@JsonProperty("sessionId") String sessionId, @JsonProperty("lastReceivedCommandId") int lastReceivedCommandId, @JsonProperty("maxRequestedCommandId") int maxRequestedCommandId) {
		super(sessionId);
