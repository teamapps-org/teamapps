...
describe('TeamApps.extractAllPossibleDateFragmentCombinations', function () {
	...
	it('returns day (!) and day-month suggestions if the input has 2 digits and is interpretable as day', function () {
		expect(new DateSuggestionEngine({preferredYearMonthDayOrder: "YMD"}).generateSuggestions("14", LocalDateTime.fromISO("2015-01-05"))).toEqual([
	...
	it('returns only day-month suggestions if the input has 2 digits and is NOT interpretable as day', function () {
		expect(new DateSuggestionEngine({preferredYearMonthDayOrder: "YMD"}).generateSuggestions("94", LocalDateTime.fromISO("2015-01-05"))).toEqual([
			LocalDateTime.fromISO("2015-09-04"),
			LocalDateTime.fromISO("2015-04-09"),
		]);
		expect(new DateSuggestionEngine({preferredYearMonthDayOrder: "YMD"}).generateSuggestions("94", LocalDateTime.fromISO("2015-10-01"))).toEqual([
	...
	it('returns only day-month suggestions if the input has 2 digits and is NOT interpretable as day - in the past, if favorPastDates == true', function () {
		expect(new DateSuggestionEngine({preferredYearMonthDayOrder: "YMD", favorPastDates: true}).generateSuggestions("94", LocalDateTime.fromISO("2015-01-05"))).toEqual([
			LocalDateTime.fromISO("2014-09-04"),
			LocalDateTime.fromISO("2014-04-09"),
		]);
		expect(new DateSuggestionEngine({preferredYearMonthDayOrder: "YMD", favorPastDates: true}).generateSuggestions("94", LocalDateTime.fromISO("2015-10-01"))).toEqual([
			LocalDateTime.fromISO("2015-09-04"),
			LocalDateTime.fromISO("2015-04-09"),
		]);
	});
	it('returns day-month and day-month-year suggestions for 3-digit inputs', function () {
		expect(new DateSuggestionEngine({preferredYearMonthDayOrder: "YMD"}).generateSuggestions("123", LocalDateTime.fromISO("2015-01-05"))).toEqual([
		...
		expect(new DateSuggestionEngine({preferredYearMonthDayOrder: "YMD"}).generateSuggestions("193", LocalDateTime.fromISO("2015-01-05"))).toEqual([
		...
		expect(new DateSuggestionEngine({preferredYearMonthDayOrder: "YMD"}).generateSuggestions("789", LocalDateTime.fromISO("2015-01-05"))).toEqual([
	...
	it('returns and day-month-year suggestions for 6-digit inputs', function () {
		expect(new DateSuggestionEngine({preferredYearMonthDayOrder: "YMD"}).generateSuggestions("121423", LocalDateTime.fromISO("2015-01-05"))).toEqual([
			LocalDateTime.fromISO("2014-12-23"),
			LocalDateTime.fromISO("2023-12-14")
		]);
		expect(new DateSuggestionEngine({preferredYearMonthDayOrder: "YMD"}).generateSuggestions("129923", LocalDateTime.fromISO("2015-01-05"))).toEqual([
			LocalDateTime.fromISO("1999-12-23")
		]);
	});
	it('returns and day-month-year suggestions for 7-digit inputs', function () {
		expect(new DateSuggestionEngine({preferredYearMonthDayOrder: "YMD"}).generateSuggestions("1211123", LocalDateTime.fromISO("2015-01-05"))).toEqual([
			LocalDateTime.fromISO("2111-01-23")
		]);
	});
	it('returns and day-month-year suggestions for 8-digit inputs', function () {
		expect(new DateSuggestionEngine({preferredYearMonthDayOrder: "YMD"}).generateSuggestions("10211123", LocalDateTime.fromISO("2015-01-05"))).toEqual([
			LocalDateTime.fromISO("2111-10-23")
		]);
	});
