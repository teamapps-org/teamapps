...
import {SplitSizePolicy} from "teamapps-client-core-components";
...
export interface ViewContainer {
	...
	moveViewRelativeToOtherView(viewName: string, existingViewName: string, relativePosition: DtoRelativeWorkSpaceViewPosition, sizePolicy: SplitSizePolicy, referenceChildSize: number): void;
	...
	addViewRelativeToOtherView(newView: DtoWorkSpaceLayoutView, existingViewName: string, relativePosition: DtoRelativeWorkSpaceViewPosition, sizePolicy: SplitSizePolicy, referenceChildSize: number): void;
