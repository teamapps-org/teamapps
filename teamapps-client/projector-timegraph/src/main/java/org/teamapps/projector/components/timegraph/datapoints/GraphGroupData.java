...
import org.teamapps.projector.components.timegraph.DtoGraphGroupData;
...
public interface GraphGroupData extends org.teamapps.projector.components.timegraph.datapoints.GraphData {

	Map<String, org.teamapps.projector.components.timegraph.datapoints.GraphData> getGraphData();

	default Interval getInterval() {
		return getGraphData().values().stream()
				.map(org.teamapps.projector.components.timegraph.datapoints.GraphData::getInterval)
