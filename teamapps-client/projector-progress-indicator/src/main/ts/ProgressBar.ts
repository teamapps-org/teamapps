...
export class ProgressBar implements ProgressIndicator {
	...
	public reset() {
		manipulateWithoutTransitions(this.$progressBar, el => el.style.width = "0%")
	}
	 ...
	 */
	public setProgress(progress: number, transitionTime = 700) {
		this.$progressBar.style.transition = `width ${transitionTime}ms linear`;
