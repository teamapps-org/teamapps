 ...
 * =========================LICENSE_END==================================
 */
package org.teamapps.projector.components.infinitescroll.recordcache;

import java.util.function.BiPredicate;

public class EqualsAndHashCode<T> {
	private final BiPredicate<T, Object> equals;
	private final HashFunction<T> hashCode;
	...
	public EqualsAndHashCode(BiPredicate<T, Object> equals, HashFunction<T> hashCode) {
		this.equals = equals;
	...
	public HashFunction<T> getHashCode() {
		return hashCode;
	}
}
