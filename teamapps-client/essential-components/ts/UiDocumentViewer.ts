...
import {css, enableScrollViaDragAndDrop, generateUUID, parseHtml} from "@teamapps/teamapps-client-core";
import {UiBorderConfig} from "./generated/UiBorderConfig";
import {createUiBorderCssString, createUiShadowCssString} from "@teamapps/teamapps-client-core";
...
export class UiDocumentViewer extends AbstractUiComponent<UiDocumentViewerConfig> implements UiDocumentViewerCommandHandler {
	...
	private updateImageSizes() {
		let viewPortWidth = this.$pagesContainerWrapper.offsetWidth - 2 * this._config.padding;
		let viewPortHeight = this.$pagesContainerWrapper.offsetHeight - 2 * this._config.padding;
