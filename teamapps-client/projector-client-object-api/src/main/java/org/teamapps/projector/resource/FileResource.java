...
public class FileResource implements Resource {
	...
	static {
		try {
			MIMETYPES_BY_FILE_EXTENSION = new ObjectMapper().readValue(FileResource.class.getResource("/org/teamapps/projector/mime/mimetypes-by-file-extension.json"), HashMap.class);
		} catch (IOException e) {
