...
public abstract class AbstractComponent implements Component {
	...
	private ClientObjectChannel clientObjectChannel;

	public AbstractComponent() {
		this.sessionContext = CurrentSessionContext.get();
	}

	protected void mapAbstractUiComponentProperties(AbstractComponentConfig uiComponent) {
	...
	protected ClientObjectChannel getClientObjectChannel() {
		if (clientObjectChannel == null) {
			clientObjectChannel = sessionContext.getClientObjectChannel(this);
		}
