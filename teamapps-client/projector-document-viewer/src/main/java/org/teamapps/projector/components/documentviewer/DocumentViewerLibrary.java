package org.teamapps.projector.components.documentviewer;
...
public class DocumentViewerLibrary implements ClientObjectLibrary {
	...
	public DocumentViewerLibrary() {
		this.resourceProvider = new ClassPathResourceProvider("org/teamapps/projector/components/documentviewer/resources/js");
	}

	@Override
	public Resource getMainJsResource() {
		return new ClassPathResource("org/teamapps/projector/components/documentviewer/resources/js/index.js", "text/javascript");
	}

	@Override
	public Resource getMainCssResource() {
		return new ClassPathResource("org/teamapps/projector/components/documentviewer/resources/js/index.css", "text/css");
	}
