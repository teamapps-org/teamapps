...
import org.teamapps.projector.dto.DtoColorPickerEventHandler;
...
public class ColorPicker extends AbstractField<Color> implements DtoColorPickerEventHandler {
	...
	@Override
	public Color doConvertClientValueToServerValue(JsonWrapper value) {
		return Color.fromHtmlString(value.getJsonNode().textValue());
	}
