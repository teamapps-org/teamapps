...
import org.teamapps.projector.components.essential.dto.DtoNavigationBar;
import org.teamapps.projector.components.essential.dto.DtoNavigationBarButton;
import org.teamapps.projector.components.essential.dto.DtoNavigationBarClientObjectChannel;
import org.teamapps.projector.components.essential.dto.DtoNavigationBarEventHandler;
import org.teamapps.projector.components.essential.progress.DefaultMultiProgressDisplay;
import org.teamapps.projector.components.essential.progress.MultiProgressDisplay;
...
public class NavigationBar extends AbstractComponent implements DtoNavigationBarEventHandler {
	...
	public DtoComponent createConfig() {
		...
		if (fanOutComponents != null) {
			uiNavigationBar.setFanOutComponents(castList(fanOutComponents));
		}
