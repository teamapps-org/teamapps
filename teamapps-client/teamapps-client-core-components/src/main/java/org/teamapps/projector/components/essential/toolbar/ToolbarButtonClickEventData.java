 ...
 * =========================LICENSE_END==================================
 */
package org.teamapps.projector.components.essential.toolbar;
...
public class ToolbarButtonClickEventData {
	...
	public ToolbarButtonClickEventData(ToolbarButton button, DropDownButtonClickInfo dropDownButtonClickInfo) {
		this.button = button;
	...
	public DropDownButtonClickInfo getDropDownButtonClickInfo() {
		return dropDownButtonClickInfo;
	}
}
