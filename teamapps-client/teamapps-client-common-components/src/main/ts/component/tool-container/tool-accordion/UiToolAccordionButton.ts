...
export class UiToolAccordionButton {
	...
	<style></style>
		...
		this.optimizedWidth = AbstractUiToolContainer.optimizeButtonWidth(this.$buttonWrapper, this.$button, (config.template as UiGridTemplate).maxHeight || UiToolAccordion.DEFAULT_TOOLBAR_MAX_HEIGHT);
