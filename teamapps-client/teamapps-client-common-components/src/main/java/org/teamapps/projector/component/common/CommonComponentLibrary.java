package org.teamapps.projector.component.common;
...
public class CommonComponentLibrary implements ComponentLibrary {
	...
	public CommonComponentLibrary() {
		this.resourceProvider = new ClassPathResourceProvider("org/teamapps/projector/component/common/resources/js");
	}

	@Override
	public Resource getMainJsResource() {
		return new ClassPathResource("org/teamapps/projector/component/common/resources/js/index.js", "text/javascript");
	}

	@Override
	public Resource getMainCssResource() {
		return new ClassPathResource("org/teamapps/projector/component/common/resources/js/index.css", "text/css");
	}
