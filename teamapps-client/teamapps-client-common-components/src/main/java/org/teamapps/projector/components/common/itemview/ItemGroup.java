 ...
 * =========================LICENSE_END==================================
 */
package org.teamapps.projector.components.common.itemview;
...
import org.teamapps.projector.components.common.dto.DtoItemViewItemGroup;
...
public class ItemGroup<HEADERRECORD, RECORD> {
	...
	public DtoItemViewItemGroup createUiItemViewItemGroup() {
		DtoItemViewItemGroup itemGroup = new DtoItemViewItemGroup(itemTemplate != null ? itemTemplate.createDtoReference() : null);
