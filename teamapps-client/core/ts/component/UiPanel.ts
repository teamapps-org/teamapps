...
export class UiPanel extends AbstractUiComponent<UiPanelConfig> implements UiPanelCommandHandler, UiPanelEventSource {
	...
	constructor(config: UiPanelConfig, context: TeamAppsUiContext) {
		...
		this.setToolbar(config.toolbar as UiComponent);
		if (config.content) {
	...
	public setToolbar(toolbar: UiComponent) {
	...
	private updateToolbarVisibility() {
		this.$toolbarContainer.classList.toggle('hidden', this.toolbar == null || (isEmptyable(this.toolbar) && this.toolbar.empty));
	}
