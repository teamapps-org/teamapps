...
import static org.teamapps.projector.dsl.generate.ErrorMessageUtil.runWithExceptionMessagePrefix;
...
public class JavaDtoGenerator {
	...
	public static void main(String[] args) throws Exception {
		...
		new JavaDtoGenerator(model).generate(targetDir);
	}

	public JavaDtoGenerator(IntermediateDtoModel model) throws IOException {
		this.model = model;
