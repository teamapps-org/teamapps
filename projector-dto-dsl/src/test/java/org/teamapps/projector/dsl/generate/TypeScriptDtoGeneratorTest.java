...
public class TypeScriptDtoGeneratorTest {
	...
	public void commandsAndEvents() throws Exception {
		executeClassTest(
				...
				"package \"x\":org.teamapps.projector.dto; class A { command c(String s, int x); event z3(int a, long b);}"
		);
	}
	...
	public void mutableProperties() throws Exception {
		executeClassTest(
				...
				"package \"x\":org.teamapps.projector.dto; class A { mutable String s;}"
		);
	}
	...
	public void mutablePropertiesReferencingOtherClasses() throws Exception {
		executeClassTest(
				...
				"package \"x\":org.teamapps.projector.dto; class X {} class A { mutable X x;}"
		);
	}
	...
	public void interfaceInteritance() throws Exception {
		executeInterfaceTest(
				"org.teamapps.projector.dto.B", "org/teamapps/dsl/TeamAppsTypeScriptGeneratorTest_interfaceInteritance.tsd", "package \"x\":org.teamapps.projector.dto; " +
	...
	public void classCommandInteritance() throws Exception {
		executeClassTest(
				"org.teamapps.projector.dto.C", "org/teamapps/dsl/TeamAppsTypeScriptGeneratorTest_classCommandInteritance.tsd", "package \"x\":org.teamapps.projector.dto; interface A { String a; command x1(String y); event z(); }"
	...
	public void referenceToClassListGeneratesCorrespondingImport() throws Exception {
		executeClassTest(
				"org.teamapps.projector.dto.B", "org/teamapps/dsl/TeamAppsTypeScriptGeneratorTest_referenceToClassListGeneratesCorrespondingImport.tsd", "package \"x\":org.teamapps.projector.dto; \tclass A {} \n"
	...
	public void referenceToEnumListGeneratesCorrespondingImport() throws Exception {
		executeClassTest(
				"org.teamapps.projector.dto.DtoCalendar", "org/teamapps/dsl/TeamAppsTypeScriptGeneratorTest_referenceToEnumListGeneratesCorrespondingImport.tsd", "package \"x\":org.teamapps.projector.dto; \tenum DtoWeekDay {SUNDAY, MONDAY }\n"
	...
	public void importStatementsForSuperClassCommandAndEventHandler() throws Exception {
		executeClassTest(
				"org.teamapps.projector.dto.B", "org/teamapps/dsl/TeamAppsTypeScriptGeneratorTest_importStatementsForSuperClassCommandAndEventHandler.tsd", "package \"x\":org.teamapps.projector.dto; \tclass A {command a(); event b();}\n"
	...
	public void staticCommands() throws Exception {
		executeClassTest("org.teamapps.projector.dto.A", "org/teamapps/dsl/TeamAppsTypeScriptGeneratorTest_staticCommands.tsd", "package \"x\":org.teamapps.projector.dto; abstract class A { static command a(String b); }"
		);
	}
	...
	public void plainObjects() throws Exception {
		...
		executeClassTest(
				"org.teamapps.projector.dto.A", "org/teamapps/dsl/TeamAppsTypeScriptDtoGeneratorTest_plainObjects.tsd", dslString
		);
	}

	@Test
	public void queries() throws Exception {
		String dslString = "package \"x\":org.teamapps.projector.dto; interface X { query queryEntries(int x) returns List<String>; }";
		executeInterfaceTest(
				"org.teamapps.projector.dto.X", "org/teamapps/dsl/TeamAppsTypeScriptDtoGeneratorTest_interfacesWithQueries.tsd", dslString
		);
	}
	...
	public void enums() throws Exception {
		executeEnumTest(
				"org.teamapps.projector.dto.E", "org/teamapps/dsl/TeamAppsTypeScriptDtoGeneratorTest_enums.tsd", "package \"x\":org.teamapps.projector.dto; enum E { "
						+ " A, B "
						+ "} "
		);
	}
	...
	public void stringEnums() throws Exception {
		executeEnumTest(
				"org.teamapps.projector.dto.E", "org/teamapps/dsl/TeamAppsTypeScriptDtoGeneratorTest_stringEnums.tsd", "package \"x\":org.teamapps.projector.dto; enum E { "
						+ " A = \"a\", B = \"b\" "
						+ "} "
		);
	}
	...
	public void crossPackageImports() throws Exception {
		executeClassTest(
				...
				"package \"xxx\":org.teamapps.projector.dto; class Location { String href; }",
				"package \"yyy\":some.other.pkg; import org.teamapps.projector.dto.Location; class X { Location location; }"
		);
	}
	...
	private void executeClassTest(String qualifiedClassName, String expectedResultResourceName, String... dslString) throws IOException {
		...
		new TypeScriptDtoGenerator(model).generateClassDefinition(model.findClassByQualifiedName(qualifiedClassName).orElseThrow(), stringWriter);
	...
	private void executeInterfaceTest(String qualifiedInterfaceName, String expectedResultResourceName, String... dslString) throws IOException {
		...
		StringWriter stringWriter = new StringWriter();
		new TypeScriptDtoGenerator(model).generateInterfaceDefinition(model.findInterfaceByQualifiedName(qualifiedInterfaceName).orElseThrow(), stringWriter);
		GeneratorTestUtil.compareCodeWithResource(expectedResultResourceName, stringWriter.toString());
	}
	...
	private void executeEnumTest(String qualifiedEnumName, String expectedResultResourceName, String... dslString) throws IOException {
		...
		StringWriter stringWriter = new StringWriter();
		new TypeScriptDtoGenerator(model).generateEnum(model.findEnumByQualifiedName(qualifiedEnumName).orElseThrow(), stringWriter);
		GeneratorTestUtil.compareCodeWithResource(expectedResultResourceName, stringWriter.toString());
	}
